...
import type { Game, Player } from "@root/types";
import * as styles from "./PlayerIndicators.module.scss";
import { getCurrentPlayer } from "@root/app/redux/selectors/game-selectors";
