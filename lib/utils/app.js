...
exports = module.exports = {
	...
	configFilesToEnvironment: function() {
		...
		process.env.CREDENTIALS_GOOGLE_SECRET = _.get(credentialsConfig, 'google.clientSecret') || '';

		process.env.CREDENTIALS_GOOGLE_CLIENTID = _.get(credentialsConfig, 'google.clientID') || '';
