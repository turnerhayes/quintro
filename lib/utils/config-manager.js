...
var config = {
	...
	credentials: {
		...
		google: {
			clientSecret: process.env.CREDENTIALS_GOOGLE_SECRET,

			clientID: process.env.CREDENTIALS_GOOGLE_CLIENTID
		}
	}	
};
...
debug(
	...
	util.inspect(
		(function() {
			...
			if (_config.credentials.facebook.appSecret) {
				_config.credentials.facebook.appSecret = '*****************';
			}
