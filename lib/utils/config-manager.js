...
if (_.isUndefined(config.app.address.port)) {
	debug('PORT environment variable: ', process.env.PORT);
	debug('APP_ADDRESS_PORT environment variable: ', process.env.APP_ADDRESS_PORT);
}
